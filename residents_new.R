...
if(resample_data){
  for(species_code in species_to_process){
    # sample the data
    data <- sample_grid_abun(species_code, path_erd, checklists, effort_thresholds, extent_space, extent_time, time_window="full", small_grid=6, large_grid=11, time_grid=7)
