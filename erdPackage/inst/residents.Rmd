...
if(params$region == "eastern_us"){
  region_of_interest <- spData::us_states %>% filter(!(tolower(NAME) %in% western_states_caps))
} else if(params$region == "western_us") {
  region_of_interest <- spData::us_states %>% filter(toupper(NAME) %in% western_states_caps)
