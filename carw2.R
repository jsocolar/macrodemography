...
saveRDS(spring_abun_data, "macrodemography/carw/spring_abun_data.RDS")
saveRDS(fall_abun_data, "macrodemography/carw/fall_abun_data.RDS")

spring_abun_data <- readRDS("macrodemography/carw/spring_abun_data.RDS")
fall_abun_data <- readRDS("macrodemography/carw/fall_abun_data.RDS")
