...
plot_ratios(cells_select[20], data=tidy_ratios_summary)
```
...
tidy_ratios_summary %>%
  ...
  summarise(across(c("median","avg","q10","q90","sd"), \(x) weighted.mean(x, 1/sd, na.rm=TRUE)), .groups="drop_last") -> data_cell
