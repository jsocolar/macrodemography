...
#'  `prod_mean` is the mean log-scale productivity index, `surv_mean` is the mean log-scale survival index.
#'
#' @export
compare_ratio_variances <- function(cell_index, data, n_ratio_min=5, warmup=1000, iter=2000, chains=3, quiet=FALSE){
