...
params$time_grid <- 7
params$tgrid_min <- c(18, 31)   # Please note, I have changed this according to pre-post breeding of sonspa!
params$tgrid_max <- c(21, 34)   # i.e., 03May-31May = weeks18-21; 03Aug-31Aug=weeks31-34  
