...
params$time_grid <- 7
params$tgrid_min <- c(19, 27)   # Please note, I have changed this according to pre-post breeding of treswa!
params$tgrid_max <- c(22, 30)   # i.e., 10May-07Jun = weeks19-22; 06jul-03Aug=weeks27-30  
