...
params$species_to_process <- c("eastow")
...
grid.arrange(grobs = plots, ncol = 6, nrow=10)
...
p
# ggsave("~/Documents/plots/eastow/VarDiff_survProd_summer_book_unsmooth.png", plot=p4, width = 40, height= 20, units = "cm")  
...
# ggsave("~/Documents/plots/eastow/winterT_surv_winter_book_unsmoothed_eastow.png", plot=p, width = 30, height = 20, units = "cm")  

p <- plot_regression(data_regression, "swe", "mean", params$plotting_xlim, fill_lim = c(-1,1))+
  theme(legend.text = element_text(size=15),
        legend.title = element_text(size=20),
        legend.key.size = unit(1, "cm"))+labs(fill="effect size")
# ggsave("~/Documents/plots/eastow/swe_surv_winter_book_unsmoothed_eastow.png", plot = p, width = 30, height = 20, units = "cm")

p <- plot_regression(data_regression, "tmax_summer", "mean", params$plotting_xlim, fill_lim = c(-1,1))+
  theme(legend.text = element_text(size = 15), 
        legend.title = element_text(size = 20), 
        legend.key.size = unit(1, "cm"))+labs(fill='effect size') 
# ggsave("~/Documents/plots/eastow/summerT_prod_summer_book_unsmooth_eastow.png", plot=p, width = 30, height= 20, units = "cm")  
...
# ggsave("~/Documents/plots/eastow/wintT_surv_wint_book_Smooth_meanProb.png", plot=p2, width = 30, height= 20, units = "cm")  
...
gridExtra::grid.arrange(p1, p2, ncol=2)
# ggsave("~/Documents/plots/eastow/summerT_prod_summer_book_Smooth_meanProb.png", plot=p2, width = 30, height= 20, units = "cm")  
...
gridExtra::grid.arrange(p1, p2, ncol=2)
# ggsave("~/Documents/plots/eastow/swe_surv_wint_book_Smooth_meanProb.png", plot=p2, width = 30, height= 20, units = "cm")  
...
p2 <- plot_smooth_mean(grid_data = grid_data, region_of_interest = region_of_interest)+
  theme(legend.text = element_text(size = 15), 
        legend.title = element_text(size = 20), 
        legend.key.size = unit(1, "cm"))+labs(fill='effect size') 
# ggsave("~/Documents/plots/eastow/varDiff_survProd_summer_book_Smoothed_meanProb.png", plot=p2, width = 30, height= 20, units = "cm")  
