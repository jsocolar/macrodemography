...
params$time_grid <- 7
params$tgrid_min <- c(22, 33)   # Please note, I have changed this according to pre-post breeding of sonspa!
params$tgrid_max <- c(25, 36)   # i.e., 31May-28June = weeks22-25; 17Aug-14Sep=weeks33-36  
